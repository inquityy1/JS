...
console.log(maskCreditCard(131262787314));
console.log(maskCreditCard('13126278731461454321'));
console.log(maskCreditCard('4320492398147589789765123'));
...
console.log(new Set('Nebojsa').size);
...
// console.log(restaurant.openingHours.mon.open); // no ?.open so it is error
...
// restaurant.orderPasta(ingredients[0], ingredients[1], ingredients[2]); same as ...ingredient
